        ...
        <div class="card-body">
            ...
            <form method="GET" action="{{ route('igi.index') }}" class="mb-4">
                <div class="row g-3">
                    ...
                    <div class="col-md-2">
                        <input type="date" name="tanggal_datang" class="form-control" value="{{ request('tanggal_datang') }}" placeholder="Tanggal Datang">
                    </div>
                    <div class="col-md-3">
                        <input type="text" name="search" class="form-control" placeholder="Cari No. IDO..." value="{{ request('search') }}">
                    </div>
                    <div class="col-md-3">
